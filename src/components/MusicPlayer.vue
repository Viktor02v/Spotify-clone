	...
	<div id="MusicPlayer" v-if="audio"
		...
		<div class="flex items-center w-1/4">
			<div class="flex items-center ml-4">
				<img class="rounded-sm shadow-2xl" width="55" :src="currentArtist.albumCover" alt="">
				<div class="ml-4">
		...
		<div class="max-w-[35p%] mx-auto w-2/4 mb-3">
			...
			<div class="flex items-center h-[25px]">
				...
				<div ref="seekerContainer" class="w-full relative mt-2 mb-3" @mouseenter="isHover = true"
					...
					<input v-model="range" type="range" ref="seeker"
						class="absolute rounded-full my-2 w-full h-0 z-40 appearance-none bg-oppacity-100  focus:outline-none accent-white"
						:class="{ 'rangeDotHidden': !isHover }" />
					<div class="pointer-events-none absolute inset-y-0 mt-[6px] w-0 left-0 z-10 h-[4px]"
				...
				<div v-if="isTrackTimeTotal" class="text-white text-[12px] pr-2 pt-[11px] pl-2"> {{ isTrackTimeTotal }}
				</div>
			</div>
		</div>
